package com.wisdom.framework.sharding.util;
...
public class DateUtil {
     ...
     * @return
     */
    public static int daysBetweenYears(Date newDate,
                                       Date oldDate) {
        Calendar calo = Calendar.getInstance();
        Calendar caln = Calendar.getInstance();
        calo.setTime(oldDate);
        caln.setTime(newDate);
        int years = caln.get(Calendar.YEAR) - calo.get(Calendar.YEAR);
        return years;
    }
     ...
     * @return
     */
    public static String getDateBetweenYear(Date date,
                                            int intBetween) {
        Calendar calo = Calendar.getInstance();
        calo.setTime(date);
        calo.add(Calendar.YEAR, intBetween);
        return String.valueOf(calo.get(Calendar.YEAR)+1);
    }
